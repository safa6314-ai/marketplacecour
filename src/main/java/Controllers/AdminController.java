...
public class AdminController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Appliquer le bon style au bouton Statistiques au démarrage
    ...
    private void openAbonnementPopup(Abonnement existing) {
        ...
        save.setOnAction(e -> {
            ...
            try {
                ...
                Abonnement a = existing == null
                        ? new Abonnement(uid, nom, prix, duree, desc)
                        : new Abonnement(existing.getIdAbonnement(), uid, nom, prix, duree, desc);
    ...
    private void clearErrors() {
        for (Label l : new Label[]{aboNomError,aboPrixError,aboDureeError,aboDescError,
                subClientError,subDateDebutError,subDateFinError,subStatutError,subAboIdError})
            l.setText("");
    }
